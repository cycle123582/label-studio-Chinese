        ...
        <div className={cn("topbar").elem("group").toClassName()}>
          ...
          {store.hasInterface("annotations:view-all") && (
            <Button
              ...
              // 3. 汉化 aria-label
              aria-label={t("lsf.compare_all_annotations", "Compare all annotations")}
              onClick={annotationStore.toggleViewingAllAnnotations}
              variant={isViewAll ? "primary" : "neutral"}
              look={isViewAll ? "filled" : "string"}
              // 4. 汉化 tooltip
              tooltip={t("lsf.compare_all_annotations", "Compare all annotations")}
              size="small"
            >
              <IconViewAll />
            </Button>
          ...
          {store.hasInterface("annotations:add-new") && (
            <Button
              ...
              // 5. 汉化 aria-label
              aria-label={t("lsf.create_annotation", "Create an annotation")}
              variant="neutral"
              size="small"
              look="string"
              // 6. 汉化 tooltip
              tooltip={t("lsf.create_new_annotation", "Create a new annotation")}
              onClick={(event) => {
