...
const OBJECTS = {
  Image: {
    ...
    settings: {
      strokeWidth: {
        title: t("pages.create_project.config.width_of_region_borders", "Width of region borders"),
        type: Number,
      ...
      zoom: {
        title: t("pages.create_project.config.allow_image_zoom", "Allow image zoom (ctrl+wheel)"),
        type: Boolean,
        param: "zoom",
      },
      zoomControl: {
        title: t("pages.create_project.config.show_controls_to_zoom", "Show controls to zoom in and out"),
        type: Boolean,
        param: "zoomControl",
      },
      rotateControl: {
        title: t("pages.create_project.config.show_controls_to_rotate", "Show controls to rotate image"),
        type: Boolean,
        param: "rotateControl",
      },
    },
  ...
  Text: {
    ...
    settings: {
      granularity: {
        title: t("pages.create_project.config.select_text_by_words", "Select text by words"),
        type: Boolean,
        param: ($obj, value) =>
...
const Labels = {
  ...
  settings: {
    placeLabelsLeft: {
      title: t("pages.create_project.config.display_labels", "Display labels:"),
    ...
    filter: {
      title: t("pages.create_project.config.add_filter_for_long_list", "Add filter for long list of labels"),
      type: Boolean,
      control: true,
      param: ($obj, value) => {
        if (value) {
