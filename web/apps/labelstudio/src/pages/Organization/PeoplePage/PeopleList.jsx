          ...
          {usersList ? (
            <div className={cn("people-list").elem("users").toClassName()}>
              <div className={cn("people-list").elem("header").toClassName()}>
                ...
                <div className={cn("people-list").elem("column").mix("email").toClassName()}>{t("people_list.email")}</div>
                <div className={cn("people-list").elem("column").mix("name").toClassName()}>{t("people_list.name")}</div>
                <div className={cn("people-list").elem("column").mix("last-activity").toClassName()}>{t("people_list.last_activity")}</div>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className={cn("people-list").elem("field").mix("avatar").toClassName()}>
                        <CopyableTooltip title={`${t("people_list.user_id")}: ${user.id}`} textForCopy={user.id}>
